  ...
  return (
    <Container>
      <svg
        ...
        viewBox="0 0 40 50"
        className="sc-bPyhqo gNCITI"
      >
        <path d="M48 280.8v7.6l8.5 7.6L73 281.2V273l-16.5 14.9-8.5-7.1zM22 324v3l4 4 7-6v-4l-7 6" fill="#5EBA7D" />
        <path d="M8 280.8v7.6l8.6 7.6L33 281.2V273l-16.4 14.9" fill="#C9CBCF" />
        <path d="M45 191h29l-14.4-15" fill="#F48024" />
        <path d="M5 191h29l-14.5-15" fill="#C9CBCF" />
        <path d="M59.6 243L74 228H45l14.6 15zM6.5 322.5L0 329h13" fill="#F48024" />
        <path
          ...
          fill="#C9CBCF"
        />
        <path d="M59.6 120l2.9 9.2h9.6l-7.7 5.6 3 9.2-7.8-5.7-7.8 5.7 3-9.2-7.7-5.6h9.6" fill="#FFD83D" />
        <path
          ...
          fill="#EAC328"
        />
        <path d="M65 408a3 3 0 100-6 3 3 0 000 6z" fill="#D1A684" />
        <path d="M85 408a3 3 0 100-6 3 3 0 000 6z" fill="#B4B8BC" />
        <path d="M105 408a3 3 0 100-6 3 3 0 000 6z" fill="current" />
        <path
          ...
          fill="#93999F"
        />
        <path d="M0 400v31h31v-31" fill="#C9CBCF" />
        <path
          d="M20 419a14 14 0 018 12H3a14.1 14.1 0 018-12v-.5a7.5 7.5 0 1111.6-8.4 7.5 7.5 0 01-2.6 8.4v.5z"
          fill="#fff"
        />
        <path d="M60 340h2v14h-2M63 341h10v8H63" fill="#C9CBCF" />
        <path d="M60 320h2v14h-2" fill="#DD3C4C" />
        <path d="M63 321h10v8H63" fill="#EEC4C8" />
        <path d="M80 320h14v14H80" fill="#FE6502" />
        <path
        ...
        <path
          ...
          fill="#F48024"
        />
        <path d="M21 527v-8h3v11H0v-11h3v8h18z" fill="#BCBBBB" />
        <path
